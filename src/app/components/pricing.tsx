  ...
  return (
    <div className="container grid gap-[50px] text-white mx-auto max-w-7xl my-[100px]">
      <div className=" grid gap-[30px] text-center" id="title">
        <h1 className="text-[54px] font-bold font-(family-name:--font-plus-jakarta-sans)">Power up your experience...</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center" id="card">
        <div className="w-full h-[647px] grid gap-[30px] auto-rows-max p-6 bg-[#10121C] rounded-3xl" id="free">
        ...
        <div className="w-full flex flex-col justify-between h-[680px] p-6 bg-white text-black rounded-3xl ">
          <div className="w-full h-fit grid gap-[40px] auto-rows-max" id="pro">
            ...
            <span className="h-px w-full bg-gradient-to-r from-transparent via-black/20 to-transparent"></span>
            <div className="grid gap-2" id="benefits">
          ...
          <div className="w-full h-fit grid gap-[30px] auto-rows-max" id="pro">
            <span className="h-px w-full bg-gradient-to-r from-transparent via-black/20 to-transparent"></span>
